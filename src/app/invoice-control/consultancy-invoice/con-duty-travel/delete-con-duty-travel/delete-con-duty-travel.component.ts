...
@Component({
  selector: 'app-delete-con-duty-travel',
  standalone: false,
  templateUrl: './delete-con-duty-travel.component.html',
  styleUrl: './delete-con-duty-travel.component.scss'
})
export class DeleteConDutyTravelComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'condtdelete', valid: true, msg: 'The Duty Travel invoice details removed successfully.' }
        };
