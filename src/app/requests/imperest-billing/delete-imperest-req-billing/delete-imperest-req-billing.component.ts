...
@Component({
  selector: 'app-delete-imperest-req-billing',
  standalone: false,
  templateUrl: './delete-imperest-req-billing.component.html',
  styleUrl: './delete-imperest-req-billing.component.scss'
})
export class DeleteImperestReqBillingComponent {
  ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'impdelete', valid: true, msg: 'The Imperest billing request removed successfully.' }
        };
