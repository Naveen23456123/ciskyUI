...
@Component({
  selector: 'app-delete-boq-attendence',
  standalone: false,
  templateUrl: './delete-boq-attendence.component.html',
  styleUrl: './delete-boq-attendence.component.scss'
})
export class DeleteBoqAttendenceComponent {
ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'atddelete', valid: true, msg: 'The BOQ Attendence removed successfully.' }
        };
