...
export class InvoiceService {
  ...
  constructor(private boqstaffService:BoqStaffInterfaceService, private boqTransportService:BoqTransportationInterfaceService,
    private boqOfficeRentService:BoqOfficeRentInterfaceService, private boqOfficeSupplyService:BoqOfficeSupplyInterfaceService,
    private boqOfficeFurnitureService:BoqOfficeFurnitureInterfaceService, private boqDutyServcie:BoqDutyTravelInterfaceService,
    private boqRoadSurveryService:BoqRoadSurveyInterfaceService,private boqReportDOcService:BoqReportDocInterfaceService,
  ...
  getBoqStaffListByProjectId(param: any, guid: string) {
    return this.boqstaffService.getBoqStaffListByProjectId(param,guid);
  }
