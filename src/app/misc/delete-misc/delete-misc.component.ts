...
@Component({
  selector: 'app-delete-misc',
  standalone: false,
  templateUrl: './delete-misc.component.html',
  styleUrl: './delete-misc.component.scss'
})
export class DeleteMiscComponent {
ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'miscdelete', valid: true, msg: 'The Miscellaneous removed successfully.' }
        };
