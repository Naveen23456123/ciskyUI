...
@Component({
  selector: 'app-delete-vehicle-log',
  standalone: false,
  templateUrl: './delete-vehicle-log.component.html',
  styleUrl: './delete-vehicle-log.component.scss'
})
export class DeleteVehicleLogComponent {
ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'logdelete', valid: true, msg: 'The Vehicle Log removed successfully.' }
        };
