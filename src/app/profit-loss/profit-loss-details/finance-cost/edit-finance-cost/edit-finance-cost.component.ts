...
@Component({
  selector: 'app-edit-finance-cost',
  standalone: false,
  templateUrl: './edit-finance-cost.component.html',
  styleUrl: './edit-finance-cost.component.scss'
})
export class EditFinanceCostComponent {
  ...
  openDialog(): void {
    ...
    config.data = {
      ...
      scope: ProfitLossScope.FINANCE_COST,
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'fcedit', valid: true, msg: 'The Finance cost updated successfully.' }
        };
