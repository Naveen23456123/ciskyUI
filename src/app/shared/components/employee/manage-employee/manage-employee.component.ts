...
public data: any;
  ...
  ngOnInit() {     
    ...
    this.employeeForm = this.formbuilder.group({ 
      ...
      emailId:['',[Validators.required,this.validatorService.Email]],
      PhoneNumber:['',[Validators.required,this.validatorService.PhoneNumber]],
      ...
      relation:[],
      AccountNumber:[],
      ifscCode:[,this.validatorService.IfscCode],
      bankName:[],
      bankAddress:[],
      AadharNumber :[],
      UanNumber:[],
      PanNumber:[,this.validatorService.PanNo],
      currentAddress:[],
      emergencyAddress:[],
