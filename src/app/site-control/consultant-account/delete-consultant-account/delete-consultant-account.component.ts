...
@Component({
  selector: 'app-delete-consultant-account',
  standalone: false,
  templateUrl: './delete-consultant-account.component.html',
  styleUrl: './delete-consultant-account.component.scss'
})
export class DeleteConsultantAccountComponent {
ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'accdelete', valid: true, msg: 'The Consultant account removed successfully.' }
        };
