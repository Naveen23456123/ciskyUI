...
@Component({
  selector: 'app-manage-dpr-invoice-list',
  standalone: false,
  templateUrl: './manage-dpr-invoice-list.component.html',
  styleUrl: './manage-dpr-invoice-list.component.scss'
})
export class ManageDprInvoiceListComponent {
invoiceList:any[]= [];
  isLoading = true;
