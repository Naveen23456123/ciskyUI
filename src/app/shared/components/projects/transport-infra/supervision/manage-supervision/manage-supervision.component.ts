...
@Component({
  selector: 'app-manage-supervision',
  standalone: false,
  templateUrl: './manage-supervision.component.html',
  styleUrl: './manage-supervision.component.scss'
})
export class ManageSupervisionComponent {
 public data: any;
  isLoading = true;
  ...
  @Optional() private dialogRef: MatDialogRef<ManageSupervisionComponent>, 
...
ngOnInit(): void {
  ...
  this.projectForm = this.formbuilder.group({ 
    ...
    contractModeId:['',Validators.required],
    lead:[''],
    jv:[''],
    ourShare:[''],
    association:[''],
