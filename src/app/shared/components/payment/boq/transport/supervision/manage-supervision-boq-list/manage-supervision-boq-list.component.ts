...
@Component({
  selector: 'app-manage-supervision-boq-list',
  standalone: false,
  templateUrl: './manage-supervision-boq-list.component.html',
  styleUrl: './manage-supervision-boq-list.component.scss'
})
export class ManageSupervisionBoqListComponent {
 itemsList:any[]= [];
  isLoading = true;
