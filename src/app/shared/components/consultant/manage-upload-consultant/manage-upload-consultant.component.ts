...
@Component({
  selector: 'app-manage-upload-consultant',
  standalone: false,
  templateUrl: './manage-upload-consultant.component.html',
  styleUrl: './manage-upload-consultant.component.scss'
})
export class ManageUploadConsultantComponent {
  ...
  constructor(@Optional() private dialogRef: MatDialogRef<ManageUploadConsultantComponent>,private projectService:ProjectInterfaceService, private sessionService:SessionService,
