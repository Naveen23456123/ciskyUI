...
@Component({
  selector: 'app-edit-emp-benefit-expense',
  standalone: false,
  templateUrl: './edit-emp-benefit-expense.component.html',
  styleUrl: './edit-emp-benefit-expense.component.scss'
})
export class EditEmpBenefitExpenseComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'empbedit', valid: true, msg: 'The Employee benefit expense updated successfully.' }
        };
