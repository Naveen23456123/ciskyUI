...
import { DeleteEmployeeComponent } from '@app/employee-control/employees/delete-employee/delete-employee.component';
...
@Component({
  ...
  standalone: false,
  templateUrl: './manage-employee-doc.component.html',
