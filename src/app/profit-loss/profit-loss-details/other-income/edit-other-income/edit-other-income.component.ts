...
@Component({
  selector: 'app-edit-other-income',
  standalone: false,
  templateUrl: './edit-other-income.component.html',
  styleUrl: './edit-other-income.component.scss'
})
export class EditOtherIncomeComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'oiedit', valid: true, msg: 'The Other income updated successfully.' }
        };
