...
@Component({
  selector: 'app-delete-veh-req-billing',
  standalone: false,
  templateUrl: './delete-veh-req-billing.component.html',
  styleUrl: './delete-veh-req-billing.component.scss'
})
export class DeleteVehReqBillingComponent {
  ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'vehreqdelete', valid: true, msg: 'The Vehicle billing request removed successfully.' }
        };
