...
@Component({
  selector: 'app-add-con-transportation',
  standalone: false,
  templateUrl: './add-con-transportation.component.html',
  styleUrl: './add-con-transportation.component.scss'
})
export class AddConTransportationComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'conttpadd', valid: true, msg: 'The Transportation invoice details created successfully.' }
        };
