...
@Component({
  selector: 'app-add-con-ofc-furniture',
  standalone: false,
  templateUrl: './add-con-ofc-furniture.component.html',
  styleUrl: './add-con-ofc-furniture.component.scss'
})
export class AddConOfcFurnitureComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'conofadd', valid: true, msg: 'The Office Furniture invoice details created successfully.' }
        };
