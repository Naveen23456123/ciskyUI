...
@Component({
  selector: 'app-manage-dpr',
  standalone: false,
  templateUrl: './manage-dpr.component.html',
  styleUrl: './manage-dpr.component.scss'
})
export class ManageDprComponent {
 public data: any;
  isLoading = true;
  ...
  @Optional() private dialogRef: MatDialogRef<ManageDprComponent>, 
