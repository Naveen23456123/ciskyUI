...
@Component({
  selector: 'app-add-con-duty-travel',
  standalone: false,
  templateUrl: './add-con-duty-travel.component.html',
  styleUrl: './add-con-duty-travel.component.scss'
})
export class AddConDutyTravelComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'condtadd', valid: true, msg: 'The Duty Travel invoice details created successfully.' }
        };
