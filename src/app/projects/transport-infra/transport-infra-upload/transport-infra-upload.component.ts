...
@Component({
  selector: 'app-transport-infra-upload',
  standalone: false,
  templateUrl: './transport-infra-upload.component.html',
  styleUrl: './transport-infra-upload.component.scss'
})
export class TransportInfraUploadComponent {
