...
@Component({
  selector: 'app-add-con-ofc-supply',
  standalone: false,
  templateUrl: './add-con-ofc-supply.component.html',
  styleUrl: './add-con-ofc-supply.component.scss'
})
export class AddConOfcSupplyComponent {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data && data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'conosadd', valid: true, msg: 'The Office Supply invoice details created successfully.' }
        };
