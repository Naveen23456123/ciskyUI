...
@Component({
  selector: 'app-delete-ofc-req-billing',
  standalone: false,
  templateUrl: './delete-ofc-req-billing.component.html',
  styleUrl: './delete-ofc-req-billing.component.scss'
})
export class DeleteOfcReqBillingComponent {
  ngOnInit(): void {
    this.openDialog();
  }
  restrictDialog() {
    ...
    dialogRef.afterClosed().subscribe((data) => {
      if (data.valid) {
        let navigationExtras: NavigationExtras = {
          ...
          state: { value: data.value, event: 'ofcreq-delete', valid: true, msg: 'The Office billing request removed successfully.' }
        };
